...
class Strings {
    ...
    static defaultData = {
        ...
        icon: {
            ...
            collapseItemIcon: '<i class="fas fa-chevron-circle-up"></i>',
            expandItemIcon: '<i class="fas fa-chevron-circle-down"></i>',
            ...
            sortUpIcon: '<i class="fas fa-sort-up"></i>',
            sortDownIcon: '<i class="fas fa-sort-down"></i>',
        },
        error: {
